...
class StudentDocumentController extends Controller
{
    ...
    {
        $student->load(['files.uploader','files.archiver','currentEnrollment','invoices']);
        return view('dashboard.students.documents', ['student'=>$student,'activeFiles'=>$student->files->whereNull('archived_at'),'archivedFiles'=>$student->files->whereNotNull('archived_at'),'completion'=>$this->completion->calculate($student)]);
    }
