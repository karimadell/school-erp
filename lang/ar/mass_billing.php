...
return [
    ...
    'duplicate_warning' => 'تنبيه: لدى :count من الطلاب المحددين فاتورة بالفعل لهذه الخدمة في السنة الدراسية الحالية. قد يكون هذا مقبولاً للخدمات المتكررة أو الدورية. قبل الإصدار، تأكد من أن هذه الدفعة لا تكرر تحصيلاً سبق تنفيذه.',
