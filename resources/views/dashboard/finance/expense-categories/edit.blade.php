...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-1">{{ __('expenses.category_edit_title') }}</h3>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('dashboard.finance.expense-categories.update', $category) }}">
                @csrf
                @method('PUT')
                @include('dashboard.finance.expense-categories._form', ['category' => $category])
