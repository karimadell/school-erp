...
class SchoolSettingsTest extends TestCase
{
    ...
    public function test_shared_pdf_header_footer_and_missing_logo_fallback(): void
    {
        ...
        // A missing/broken uploaded logo path now falls back to the
        // bundled public/images/school-logo.png (see
        // SchoolSetting::documentLogoAsset()) instead of leaving the
        // document logo-less.
